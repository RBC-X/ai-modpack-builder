"""Pack Detail tab renderers - cohesive mixins for PackDetailView.
"""
...
from PyQt6.QtWidgets import (QCheckBox, QComboBox, QDialog, QFrame, QHBoxLayout,
                             QLabel, QLineEdit, QPlainTextEdit, QSlider, QVBoxLayout,
                             QWidget)

import theme
from common import (avatar, button, card, clear_layout, fmt_bytes, fmt_time, hbox,
                    icon_btn, icon_cache, icon_pixmap, label, pill, progress,
                    run_async, start_stream, vbox)
